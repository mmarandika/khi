...
// print_r($parse);
if($_SERVER['SERVER_NAME'] == "genx.click") {
    header("Location: https://khi.red");
    exit;
}
include('config.php');
    ...
    if(Order::userHasOrder($username) || $usergroup == 0 ) {
        if(false === Order::isExpired($username) || $usergroup == 0) {
            ...
            if(!isset($domains['error'])) {
                ...
                Jika lambat, gunakan <a href=\"https://khi.red\">https://khi.red</a>
                </div>
                ...
                <div class='card card-default'>
                    <div class='card-body'>
                        ...
                        <div class='row'>
                            <div class='col col-md-6'>
                                <div class='form-group'>
                                    ...
                                    <option value='randomSpecial'>Random Special</option>
                                    <option value=''>---------------</option>";
                            if(count($domains) > 0) {
                                foreach( $domains as $k => $v) {
                                    $special = ($v->special == 1 ) ? "&#9733;": "&nbsp;";
                                    echo "<option  value='".$v->name."' >".$v->name." {$special}</option>";
                                }
                            }
                            echo "</select>
                                </div>
                            ...
                            <div class='col col-md-6'>
                                <div class='form-group'>
                                    ...
                                    <option value='myrandomSpecial'>Random Special</option>
                                    <option value=''>---------------</option>";
                        ...
                        <div class='form-group'>
                            ...
                            <input type=\"number\" id=\"amount\" class=\"form-control\" min=\"1\" max=\"20\" value=\"1\" aria-label=\"Example text with button addon\" aria-describedby=\"button-addon1\">
                        </div>
                        <!-- Nav tabs -->
                            ...
                            <br />
                                ...
                                <div class='row'>
                                    ...
                                    <div class='col-md-12'>
                                        ...
                                        <label>Image</label>
                                            <div class='input-group'>
                                                <input type='text' name='image' id='custom_image' class='form-control form-control-sm' placeholder='link ke gambar'>
                                                <div class='input-group-append'>
            ...
            echo "Akun Anda sudah expired. <a href='order.php' class='bold'>Klik disini</a> Untuk berlangganan.";
        }
    } else {
